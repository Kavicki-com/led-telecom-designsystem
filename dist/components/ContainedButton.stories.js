...
exports.States = exports.Disabled = exports.IconOnly = exports.WithRightIcon = exports.WithLeftIcon = exports.Default = void 0;
const jsx_runtime_1 = require("react/jsx-runtime");
const ContainedButton_1 = require("./ContainedButton");
const meta = {
    title: 'Components/Button',
    component: ContainedButton_1.ContainedButton,
    parameters: {
        layout: 'centered',
        docs: {
            description: {
...
exports.States = {
    render: () => ((0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'center' }, children: [(0, jsx_runtime_1.jsx)(ContainedButton_1.ContainedButton, { label: "Default", state: "default" }), (0, jsx_runtime_1.jsx)(ContainedButton_1.ContainedButton, { label: "Hover", state: "hover" }), (0, jsx_runtime_1.jsx)(ContainedButton_1.ContainedButton, { label: "Pressed", state: "pressed" }), (0, jsx_runtime_1.jsx)(ContainedButton_1.ContainedButton, { label: "Disabled", state: "disable", disabled: true })] })),
    parameters: {
        docs: {
            description: {
...
//# sourceMappingURL=ContainedButton.stories.js.map