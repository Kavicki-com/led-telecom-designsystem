 ...
 */
export function generateCSSVariables(tokens: any, prefix: string = 'led'): string {
    let css = '';

    function processObject(obj: any, currentPath: string = ''): void {
 ...
 */
export function generateFullCSS(prefix: string = 'led'): string {
    const variables = generateCSSVariables(designTokens, prefix);
 ...
 */
export function getCSSVariable(path: string, prefix: string = 'led'): string {
